...
const locale = {
  ...
  'strategyIde.selectScriptLabel': 'Script',
  ...
  'community.useScriptStrategy': 'Open trading script',
  ...
  'dashboard.analysis.source.prefix': 'Source · {source}',
  'dashboard.analysis.source.forex': 'Public FX data',
  'dashboard.analysis.source.crypto': 'Exchange market data',
  'dashboard.analysis.source.usStock': 'US stock data',
  'dashboard.analysis.source.cnStock': 'A-share data',
  'dashboard.analysis.source.hkStock': 'HK stock data',
  'dashboard.analysis.source.futures': 'Futures data',
  'dashboard.analysis.source.moex': 'MOEX data',
  ...
  'dashboard.analysis.modal.addStock.example.MT5': 'e.g. XAUUSD, XAGUSD, EURUSD',
  ...
  'dashboard.analysis.market.MT5': 'MT5 / CPT Markets',
  ...
  'dashboard.indicator.market.MT5': 'MT5 / CPT Markets',
  ...
  'trading-assistant.market.MT5': 'MT5 / CPT Markets',
  ...
  'trading-assistant.form.mt5MarketTypeHint': 'MT5 / CPT Markets runs through the local terminal. Orders use broker lots and support buy/sell directions.',
  ...
  'trading-assistant.validation.mt5OnlyForMT5': 'MT5 / CPT Markets credentials can only be used with the MT5 market.',
  ...
  'trading-assistant.editor.templateIntroDesc': 'Start from a blank script or a classic script template. Symbol, spot/swap, direction, investment amount, and leverage are selected in the run panel.',
  ...
  'trading-assistant.editor.statefulTemplateSection': 'Classic script templates',
  ...
  'quickTrade.liveAccountsHint': 'Crypto / MT5',
  'quickTrade.noExchange': 'No supported trading accounts yet. Add one in Broker Accounts.',
  ...
  'quickTrade.mt5ModeHint': 'MT5 / CPT Markets uses broker lots through the local terminal. Buy opens or increases long; sell opens or increases short.',
  ...
  'profile.exchange.typeMT5': 'MT5 / CPT Markets',
  ...
  'profile.exchange.mt5LocalTitle': 'Windows MT5 terminal required',
  'profile.exchange.mt5LocalHint': 'CPT Markets / MT5 uses the official MetaTrader5 Python package and a logged-in local MetaTrader 5 terminal. Run the backend on that Windows host for real trading.',
  'profile.exchange.mt5Login': 'MT5 Login',
  'profile.exchange.mt5Password': 'MT5 Password',
  'profile.exchange.mt5PasswordPh': 'Trading account password',
  'profile.exchange.mt5Server': 'MT5 Server',
  'profile.exchange.mt5PathOptional': 'Terminal path (optional)',
  'profile.exchange.mt5Timeout': 'Timeout (ms)',
  'profile.exchange.mt5SymbolPrefix': 'Symbol prefix',
  'profile.exchange.mt5SymbolSuffix': 'Symbol suffix',
  ...
  // ===== Trading Assistant: script-code templates =====
  ...
  'brokerAccounts.subtitle': 'Manage exchange credentials and live connections to Alpaca / Interactive Brokers / MT5 — accounts, positions, and open orders — in one place.',
  'brokerAccounts.cryptoSection.title': 'Trading Accounts',
  'brokerAccounts.cryptoSection.subtitle': 'These accounts are stored as encrypted credentials in the database and used by template strategies and live strategies. Supports crypto exchanges plus MT5 / CPT Markets.',
  ...
  'brokerAccounts.mt5.localHint': 'For real CPT Markets orders, start the backend on the same Windows machine as MetaTrader 5.',
  'brokerAccounts.mt5.login': 'Login',
  'brokerAccounts.mt5.password': 'Password',
  'brokerAccounts.mt5.passwordPh': 'Trading account password',
  'brokerAccounts.mt5.server': 'Server',
  'brokerAccounts.mt5.serverHint': 'Type the exact server name shown in the MT5 login window.',
  'brokerAccounts.mt5.pathOptional': 'Terminal path (optional)',
  'brokerAccounts.mt5.timeout': 'Timeout (ms)',
  'brokerAccounts.mt5.symbolPrefix': 'Prefix',
  'brokerAccounts.mt5.symbolSuffix': 'Suffix',
...
const copilotI18nPatch = {
  ...
  "aiAssetAnalysis.copilot.monitors": "AI Scheduled Analysis",
  "aiAssetAnalysis.copilot.noMonitors": "No scheduled tasks",
  "aiAssetAnalysis.copilot.indicatorStrategy": "Indicator Strategy",
  "aiAssetAnalysis.copilot.indicatorStrategyDesc": "Generate indicator strategy drafts for display, backtest, and publishing.",
  "aiAssetAnalysis.copilot.scriptStrategy": "Trading Script",
  "aiAssetAnalysis.copilot.scriptStrategyDesc": "Generate Python ScriptStrategy drafts for the Trading Script editor.",
  "aiAssetAnalysis.copilot.tradingBot": "Strategy Template",
  "aiAssetAnalysis.copilot.tradingBotDesc": "Create strategy template plans with parameters and risk controls.",
  ...
  "aiAssetAnalysis.copilot.generatingIndicatorStrategy": "Generating indicator strategy draft...",
  "aiAssetAnalysis.copilot.indicatorStrategyReady": "Indicator strategy draft is ready.",
  "aiAssetAnalysis.copilot.openStrategyResearch": "Open Indicator Strategy editor",
  "aiAssetAnalysis.copilot.generatingScriptStrategy": "Generating trading script draft...",
  "aiAssetAnalysis.copilot.scriptStrategyReady": "Trading script draft is ready.",
  "aiAssetAnalysis.copilot.openScriptStrategyIde": "Open Trading Script editor",
  "aiAssetAnalysis.copilot.generatingTemplateStrategy": "Generating strategy template plan...",
  "aiAssetAnalysis.copilot.openTemplateStrategy": "Open Strategy Template",
  ...
  "aiAssetAnalysis.copilot.strategyExamples.code": "Turn my trading idea into a QuantDinger Python trading script with trend filter, entries/exits, position sizing, stop/take-profit, logs, and validation steps.",
  ...
  "aiAssetAnalysis.copilot.strategyPrompt.targetScript": "Target type: Trading Script. It should fit Python ScriptStrategy with state management, order logic, risk parameters, error handling, and logging.",
  "aiAssetAnalysis.copilot.strategyPrompt.targetTemplate": "Target type: Strategy Template. First decide whether grid, trend, DCA, martingale, or another strategy template type fits best, then explain why and list key parameters.",
  ...
  "aiAssetAnalysis.copilot.strategyExamples.gridTemplate": "Evaluate whether {symbol} is suitable for a grid strategy template. Recommend price range, grid count, budget, stop condition, and when not to run it.",
  "aiAssetAnalysis.copilot.strategyExamples.trendTemplate": "Create a trend-following strategy template plan for {symbol}: entry trigger, trailing stop, take-profit logic, position size, and manual review checklist.",
  ...
  "aiAssetAnalysis.copilot.strategyPrompt.workflowScript": "Run location: Trading Script editor. Generate QuantDinger Python ScriptStrategy code, not indicator output code.",
  "aiAssetAnalysis.copilot.strategyPrompt.workflowTemplate": "Run location: Strategy Template. Generate a strategy template recommendation and parameters, not custom Python code.",
