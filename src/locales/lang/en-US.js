...
const locale = {
  ...
  'settings.llm.currentProviderDesc': 'Only the selected provider fields are shown below. Hidden provider credentials are kept unchanged when you save.',
  ...
  'settings.desc.ATLASCLOUD_MODEL': 'AtlasCloud model id. Copy it from AtlasCloud model docs, e.g. deepseek-v3; do not enter other-provider or OpenRouter-prefixed ids such as xai/grok-4.3.',
